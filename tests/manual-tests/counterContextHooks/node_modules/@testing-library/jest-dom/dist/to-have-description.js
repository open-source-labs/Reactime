...
function toHaveDescription(htmlElement, checkWith) {
  ...
  return {
    ...
    message: () => {
      ...
      return (0, _utils.getMessage)((0, _jestMatcherUtils.matcherHint)(`${this.isNot ? '.not' : ''}.toHaveDescription`, 'element', ''), `Expected the element ${to} have description`, (0, _jestMatcherUtils.printExpected)(checkWith), 'Received', (0, _jestMatcherUtils.printReceived)(description));
    }
  };
}