                ...
                <div className='mt-20'>
                  ...
                  <div className='mt-6 sm:max-w-xl'>
                    ...
                    <p className='mt-6 text-xl text-gray-500'>
                      A Chrome Extension that lets you rewind time and replay previous versions of
                      your stateful React components.
                    </p>
                  </div>
                  ...
                  <div className='mt-6'>
                    <div className='inline-flex items-center'>
                      ...
                      <div className='min-w-0 inline py-1 text-sm text-gray-500 sm:py-3'>
                        <StarIcon
                          className='h-5 w-5 mb-1 mr-2 text-yellow-400 inline'
                          aria-hidden='true'
                        />
                        <span className='font-medium text-gray-900'> Starred on GitHub</span> by
                        over <span className='font-medium text-rose-500'>1,700 users</span>
                        <StarIcon
                          className='h-5 w-5 ml-2 mb-1 text-yellow-400 inline'
                          aria-hidden='true'
                        />
                      </div>
                    </div>
