...
const resolveTheme = async (themeSpec, configFileThatDeclaredTheme, isMainConfig = false) => {
  ...
  const {
    configModule,
    configFilePath
  } = await getConfigFile(themeDir, `gatsby-config`);
  let theme = preferDefault(configModule); // if theme is a function, call it with the themeConfig
